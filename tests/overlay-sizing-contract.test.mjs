...
const css = read("src/styles/ui-adjustment.css");
const overlayCss = read("src/styles/overlay.css");

test("overlay sizing is one fixed base viewport multiplied by UI scale", () => {
  ...
  assert.doesNotMatch(bridge, /getBoundingClientRect|scrollWidth|scrollHeight|ResizeObserver/);
