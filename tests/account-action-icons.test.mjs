...
const css = fs.readFileSync("src/styles/account-card-actions.css", "utf8");
const poolCss = fs.readFileSync("src/styles/codex-pools.css", "utf8");
...
test("reauth, refresh, models, apply, and active mark share the same 22px control box", () => {
  const authCss = fs.readFileSync("src/styles/account-auth.css", "utf8");
