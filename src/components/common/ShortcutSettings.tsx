      ...
      <div className="settings-shortcut-row">
        ...
        <div className="settings-shortcut-controls">
          <button
            ...
            onClick={() => setRecordingKey(recordingKey === "toggleOverlay" ? null : "toggleOverlay")}
            title="Click to record a new shortcut"
          >
            {recordingKey === "toggleOverlay" ? "Press keys..." : formatShortcutDisplay(prefs.toggleOverlay)}
          </button>
      ...
      <div className="settings-shortcut-row">
        ...
        <div className="settings-shortcut-controls">
          <button
            ...
            onClick={() => setRecordingKey(recordingKey === "refreshAccount" ? null : "refreshAccount")}
            title="Click to record a new shortcut"
          >
            {recordingKey === "refreshAccount" ? "Press keys..." : formatShortcutDisplay(prefs.refreshAccount)}
          </button>
